...
replace (
	github.com/olivere/elastic/v7 => github.com/DataDog/temporal-elastic/v7 v7.0.32-dd-aws-sdk-2
	github.com/smartystreets/assertions => github.com/smarty/assertions v1.14.0
	github.com/smartystreets/gunit => github.com/smarty/gunit v1.4.0
)
